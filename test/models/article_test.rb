...
test "edit article with invalid, title is blank" do
  article = Article.first
  assert_equal false, article.update_attributes(title: "", content: "lorem ipsum heroda kara",status: "active")
end

test "edit article with invalid data, title < 5" do
  article = Article.first
assert_equal false, article.update_attributes(title: "abcd", content: "lorem ipsum heroda kara",status: "active")
end

test "edit article with invalid data, content is blank" do
  article = Article.first
  assert_equal false, article.update_attributes(title: "learn uni test", content: "",status: "active")
end

test "edit article with invalid data, content < 10" do
  article = Article.first
  assert_equal false, article.update_attributes(title: "learn uni test", content: "abcde fg",status: "active")
end

test "edit article with invalid data, status is blank" do
  article = Article.first
  assert_equal false, article.update_attributes(title: "learn unit test", content: "conten of article learn unit test",status: "")
end

test "edit article with valid data" do
  article = Article.first
  assert_equal true, article.update_attributes(title: "Edit Testing", content: "Edit This is body")
end
#----------------End Test Validation-----------------
